  ...
  return (
    <section id="collections" className="py-24 bg-secondary/30">
      <div className="container mx-auto px-4 text-center mb-16">
        <h4 className="text-accent uppercase tracking-[0.3em] font-bold text-sm mb-4">The Selection</h4>
        <h2 className="font-headline text-4xl md:text-6xl text-primary mb-6">Current Collections</h2>
          ...
          <div key={item.id} className="group cursor-pointer">
            <div className="relative aspect-[3/4] overflow-hidden mb-6">
              ...
              <div className="absolute bottom-6 left-1/2 -translate-x-1/2 translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                <Button variant="secondary" className="rounded-none px-8 py-6 uppercase tracking-widest text-xs">View Details</Button>
              </div>
            </div>
            <h3 className="font-headline text-2xl text-primary mb-2">{item.description}</h3>
            <p className="text-sm text-muted-foreground uppercase tracking-widest">Seasonal Essential</p>
          </div>
        ))}
      </div>
