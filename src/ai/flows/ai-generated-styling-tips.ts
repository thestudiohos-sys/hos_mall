...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a highly creative and sophisticated fashion stylist and copywriter for H.O.S_Mall, a luxury clothing brand known for its timeless elegance and refined minimalism.
...
The evocative description should highlight the premium fabric, clean lines, and the sense of sophistication it provides the wearer.
